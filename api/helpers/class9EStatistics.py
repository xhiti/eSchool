...
class PrintStatistics9E:

    @staticmethod
    def print9EStatisticFullYear(grades):
        file_name = 'Statistika Vjetore Klasa IX-E.pdf'
        response = HttpResponse(content_type='application/pdf')
        response['Content-Disposition'] = 'attachment; filename="' + file_name + '"'
        elements = []

        doc = BaseDocTemplate(filename=response, pagesize=A4, title='Statistika Vjetore Klasa IX-E ' + str(datetime.now().year))
        ...
        def header(canvas, doc):
            ...
            text_serial = "Vlerësimi i nxënësve IX-E " + str(datetime.now().year)
        ...
        elements.append(Paragraph("<b> KLASA IX-E</b>", title_style_2))
    ...
    @staticmethod
    def print9EStatisticFirstPeriod():
        file_name = 'Statistika Periudha 1 Klasa IX-E.pdf'
        response = HttpResponse(content_type='application/pdf')
        response['Content-Disposition'] = 'attachment; filename="' + file_name + '"'
        elements = []

        doc = BaseDocTemplate(filename=response, pagesize=A4,
                              title='Statistika Periudha 1 Klasa IX-E ' + str(datetime.now().year))
        ...
        def header(canvas, doc):
            canvas.line(HEADER_LINE_X1, HEADER_LINE_Y1, HEADER_LINE_X2, HEADER_LINE_Y2)
            canvas.setFont('Arial Narrow', 9)
            text_serial = "Statistika Klasa IX-E " + str(datetime.now().year)
            canvas.drawRightString(SERIAL_NUMBER_X, SERIAL_NUMBER_Y, text_serial)
            canvas.drawString(INSTITUTION_X, INSTITUTION_Y, 'Shkolla 9-vjeçare "Azem Hajdari"')
        ...
        # ============================= #
        elements.append(Spacer(DEAFULT_SPACE_WIDTH, DEAFULT_SPACE_HEIGHT))
        elements.append(Paragraph("<b>STATISTIKË PERIUDHA 1 KLASA IX-E</b>", title_style))
    ...
    @staticmethod
    def print9EStatisticSecondPeriod():
        file_name = 'Statistika Periudha 2 Klasa IX-E.pdf'
        response = HttpResponse(content_type='application/pdf')
        response['Content-Disposition'] = 'attachment; filename="' + file_name + '"'
        elements = []

        doc = BaseDocTemplate(filename=response, pagesize=A4,
                              title='Statistika Periudha 2 Klasa IX-E ' + str(datetime.now().year))
        ...
        # ============================= #
        elements.append(Spacer(DEAFULT_SPACE_WIDTH, DEAFULT_SPACE_HEIGHT))
        elements.append(Paragraph("<b>STATISTIKË PERIUDHA 2 KLASA IX-E</b>", title_style))
    ...
    @staticmethod
    def print9EStatisticThirdPeriod():
        file_name = 'Statistika Periudha 3 Klasa IX-E.pdf'
        response = HttpResponse(content_type='application/pdf')
        response['Content-Disposition'] = 'attachment; filename="' + file_name + '"'
        elements = []

        doc = BaseDocTemplate(filename=response, pagesize=A4,
                              title='Statistika Periudha 3 Klasa IX-E ' + str(datetime.now().year))
        ...
        # ============================= #
        elements.append(Spacer(DEAFULT_SPACE_WIDTH, DEAFULT_SPACE_HEIGHT))
        elements.append(Paragraph("<b>STATISTIKË PERIUDHA 3 KLASA IX-E</b>", title_style))
