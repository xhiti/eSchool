...
class PrintStatistics8A:

    @staticmethod
    def print8AStatisticFullYear(grades):
        file_name = 'Statistika Vjetore Klasa VIII-A.pdf'
        response = HttpResponse(content_type='application/pdf')
        response['Content-Disposition'] = 'attachment; filename="' + file_name + '"'
        elements = []

        doc = BaseDocTemplate(filename=response, pagesize=A4, title='Statistika Vjetore Klasa VIII-A ' + str(datetime.now().year))
        ...
        def header(canvas, doc):
            ...
            text_serial = "Vlerësimi i nxënësve VIII-A " + str(datetime.now().year)
        ...
        elements.append(Paragraph("<b> KLASA VIII-A</b>", title_style_2))
    ...
    @staticmethod
    def print8AStatisticFirstPeriod():
        file_name = 'Statistika Periudha 1 Klasa VIII-A.pdf'
        response = HttpResponse(content_type='application/pdf')
        response['Content-Disposition'] = 'attachment; filename="' + file_name + '"'
        elements = []

        doc = BaseDocTemplate(filename=response, pagesize=A4,
                              title='Statistika Periudha 1 Klasa VIII-A ' + str(datetime.now().year))
        ...
        def header(canvas, doc):
            canvas.line(HEADER_LINE_X1, HEADER_LINE_Y1, HEADER_LINE_X2, HEADER_LINE_Y2)
            canvas.setFont('Arial Narrow', 9)
            text_serial = "Statistika Klasa VIII-A " + str(datetime.now().year)
            canvas.drawRightString(SERIAL_NUMBER_X, SERIAL_NUMBER_Y, text_serial)
            canvas.drawString(INSTITUTION_X, INSTITUTION_Y, 'Shkolla 9-vjeçare "Azem Hajdari"')
        ...
        # ============================= #
        elements.append(Spacer(DEAFULT_SPACE_WIDTH, DEAFULT_SPACE_HEIGHT))
        elements.append(Paragraph("<b>STATISTIKË PERIUDHA 1 KLASA VIII-A</b>", title_style))
    ...
    @staticmethod
    def print8AStatisticSecondPeriod():
        file_name = 'Statistika Periudha 2 Klasa VIII-A.pdf'
        response = HttpResponse(content_type='application/pdf')
        response['Content-Disposition'] = 'attachment; filename="' + file_name + '"'
        elements = []

        doc = BaseDocTemplate(filename=response, pagesize=A4,
                              title='Statistika Periudha 2 Klasa VIII-A ' + str(datetime.now().year))
        ...
        # ============================= #
        elements.append(Spacer(DEAFULT_SPACE_WIDTH, DEAFULT_SPACE_HEIGHT))
        elements.append(Paragraph("<b>STATISTIKË PERIUDHA 2 KLASA VIII-A</b>", title_style))
    ...
    @staticmethod
    def print8AStatisticThirdPeriod():
        file_name = 'Statistika Periudha 3 Klasa VIII-A.pdf'
        response = HttpResponse(content_type='application/pdf')
        response['Content-Disposition'] = 'attachment; filename="' + file_name + '"'
        elements = []

        doc = BaseDocTemplate(filename=response, pagesize=A4,
                              title='Statistika Periudha 3 Klasa VIII-A ' + str(datetime.now().year))
        ...
        # ============================= #
        elements.append(Spacer(DEAFULT_SPACE_WIDTH, DEAFULT_SPACE_HEIGHT))
        elements.append(Paragraph("<b>STATISTIKË PERIUDHA 3 KLASA VIII-A</b>", title_style))
