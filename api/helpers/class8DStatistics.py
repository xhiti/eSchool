...
class PrintStatistics8D:

    @staticmethod
    def print8DStatisticFullYear(grades):
        ...
        def header(canvas, doc):
            ...
            text_serial = "Vlerësimi i nxënësve VIII-D " + str(datetime.now().year)
        ...
        elements.append(Paragraph("<b> KLASA VIII-D</b>", title_style_2))
    ...
    @staticmethod
    def print8DStatisticFirstPeriod():
        file_name = 'Statistika Periudha 1 Klasa VIII-D.pdf'
        response = HttpResponse(content_type='application/pdf')
        response['Content-Disposition'] = 'attachment; filename="' + file_name + '"'
        elements = []

        doc = BaseDocTemplate(filename=response, pagesize=A4,
                              title='Statistika Periudha 1 Klasa VIII-D ' + str(datetime.now().year))
    ...
    @staticmethod
    def print8DStatisticSecondPeriod():
        file_name = 'Statistika Periudha 2 Klasa VIII-D.pdf'
        response = HttpResponse(content_type='application/pdf')
        response['Content-Disposition'] = 'attachment; filename="' + file_name + '"'
        elements = []

        doc = BaseDocTemplate(filename=response, pagesize=A4,
                              title='Statistika Periudha 2 Klasa VIII-D ' + str(datetime.now().year))
    ...
    @staticmethod
    def print8DStatisticThirdPeriod():
        file_name = 'Statistika Periudha 3 Klasa VIII-D.pdf'
        response = HttpResponse(content_type='application/pdf')
        response['Content-Disposition'] = 'attachment; filename="' + file_name + '"'
        elements = []

        doc = BaseDocTemplate(filename=response, pagesize=A4,
                              title='Statistika Periudha 3 Klasa VIII-D ' + str(datetime.now().year))
